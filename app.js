...
for (const coursesAndDurationArrayElement of coursesAndDurationArray1) {
    let div = document.createElement("div");
    div.innerText = `Модуль: ${coursesAndDurationArrayElement.title}, Тривалість: ${coursesAndDurationArrayElement.monthDuration} місяців.`;
    document.body.appendChild(div);
}
...
for (const coursesAndDurationArray2Element of coursesAndDurationArray2) {
    ...
    h1.innerHTML = `<h1 class='heading'>${coursesAndDurationArray2Element.title}</h1>`;
    p.innerHTML = `<p class='description'>${coursesAndDurationArray2Element.monthDuration} month,</p>`
...
for (const simpson of simpsons) {
    let div = document.createElement("div");
    div.innerText = `${simpson.name} - ${simpson.surname} - ${simpson.age} years`;
    let h6 = document.createElement("h6");
    h6.innerText = `${simpson.info}`;
    let img = document.createElement("img");
    img.classList.add("img");
    img.src = `${simpson.photo}`;

    document.body.append(div, h6, img);
}
